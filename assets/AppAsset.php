...
class AppAsset extends AssetBundle
{
    ...
    public $css = [
        ...
        '//fonts.googleapis.com/css2?family=Exo+2:wght@400&display=swap',
        '//fonts.googleapis.com/css2?family=Exo+2:wght@500&display=swap',
        '//fonts.googleapis.com/css2?family=Manrope:wght@400&display=swap',
